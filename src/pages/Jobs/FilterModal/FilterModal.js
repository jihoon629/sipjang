...
const FILTERS = {
  ...
  혜택: ["식사제공", "숙소제공", "교통비지원"],
  직종: [
    { group: "일반인부", items: ["보통인부", "자재정리", "신호수", "준공청소", "해체정리", "작업팀장", "세대청소", "곰방", "양중", "안전관리", "안전시설", "화재감시자", "안전감시단", "농촌", "기타", "경계석공", "토류판공", "보양공", "전기공", "알폼", "경비원", "할석공", "직영-건축반장", "직영-안전반장", "미화", "고정 신호수"] },
    { group: "기능공", items: ["건축배관", "형틀목공", "강구조", "건축목공"] },
  ]
};
