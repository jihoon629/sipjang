...
function Footer() {
  ...
  return (
    <footer className="footer-nav">
      ...
      <Link to="/applications" className={pathname.startsWith("/applications") ? "active" : ""}>
        <svg className="footer-icon" width="26" height="26" viewBox="0 0 24 24" fill="none">
          <path d="M12 21c4.97 0 9-4.03 9-9s-4.03-9-9-9-9 4.03-9 9 4.03 9 9 9Zm0-4v-4m0 0V7m0 4h4m-4 0H8" stroke={pathname.startsWith("/applications") ? "#4666e4" : "#444"} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
